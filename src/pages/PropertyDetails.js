          ...
          <div className="flex-1 bg-white w-full mb-8 border border-gray-300 rounded-lg px-6 py-8 ">
            ...
            <form className="flex flex-col gap-y-4 ">
              ...
              <textarea
                ...
                placeholder="Message"
                defaultValue="Hello I am intersted in  [Modern apartment]"
              ></textarea>
              <div className="flex gap-x-2 ">
                <button className="bg-violet-700 hover:bg-violet-800 text-white rounded p-4 text-sm w-full transition ">
                  Send message
                </button>
                <button className="border border-violet-700 text-violet-700 hover:border-violet-00 hover:text-violet-500 rounded p-4 text-sm w-full transition ">
                  Call
                </button>
              </div>
            </form>
